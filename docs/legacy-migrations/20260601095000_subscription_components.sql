-- CreateEnum
CREATE TYPE "package_status" AS ENUM ('DRAFT', 'ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "benefit_package_type" AS ENUM ('WASH_CAR', 'CAR_SWAP', 'POINTS', 'DRIVER_SERVICE', 'OTHER');
...
CREATE TABLE "vehicle_package" (
    ...
    "min_purchase_price_amount" BIGINT NOT NULL,
    "max_purchase_price_amount" BIGINT NOT NULL,
...
CREATE TABLE "benefit_package" (
    ...
    "product_id" UUID NOT NULL,
    "product_version_id" UUID NOT NULL,
    "benefit_type" "benefit_package_type" NOT NULL,
...
-- CreateIndex
CREATE INDEX "vehicle_package_product_id_product_version_id_package_name_idx" ON "vehicle_package"("product_id", "product_version_id", "package_name");
...
-- CreateIndex
CREATE INDEX "mileage_package_product_id_product_version_id_package_name_idx" ON "mileage_package"("product_id", "product_version_id", "package_name");
...
-- CreateIndex
CREATE INDEX "energy_package_product_id_product_version_id_package_name_idx" ON "energy_package"("product_id", "product_version_id", "package_name");
...
-- CreateIndex
CREATE INDEX "benefit_package_product_id_product_version_id_package_name_idx" ON "benefit_package"("product_id", "product_version_id", "package_name");
