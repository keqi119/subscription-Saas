export enum PermissionCode {
  ...
  VEHICLE_RETURN_VIEW = "vehicle_return:view",
  VEHICLE_RETURN_PREPARE = "vehicle_return:prepare",
  VEHICLE_RETURN_CONFIRM = "vehicle_return:confirm",
  VEHICLE_RETURN_DAMAGE_RECORD = "vehicle_return:damage_record",
