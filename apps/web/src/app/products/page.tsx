...
import { CheckOutlined, DeleteOutlined, EditOutlined, PlusOutlined, PoweroffOutlined } from "@ant-design/icons";
import {
  App,
  Button,
  DatePicker,
...
const packageMeta: Record<PackageKind, { createText: string; endpoint: string; tab: string; title: string }> = {
  ...
  vehicle: { createText: "新增车型包", endpoint: "vehicle-packages", tab: "vehicle-packages", title: "车型包" }
};
...
function ProductsPageContent() {
  ...
  const versionOptions = products.flatMap((product) =>
    product.versions.map((version) => ({
      label: `${product.productNo} / ${product.name} / ${version.versionNo}`,
