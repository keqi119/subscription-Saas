...
- [ ] **Step 1: Write the failing schema and RBAC contract tests**
...
- [ ] **Step 3: Add schema models and database constraints**
...
- [ ] **Step 4: Add shared permissions, seed assignments, menu seed, and labels**
...
- [ ] **Step 5: Apply and validate the migration**
...
- [ ] **Step 1: Write failing unit tests for date and snapshot invariants**
...
- [ ] **Step 2: Run the segment tests and confirm RED**
...
- [ ] **Step 3: Implement focused segment service and typed errors**
...
- [ ] **Step 4: Wire the module and run GREEN tests**
...
- [ ] **Step 5: Commit the segment source of truth**
...
- [ ] **Step 3: Implement feature config, DTO validation, and pricing service**
...
- [ ] **Step 4: Implement lifecycle service and Admin controller**
...
- [ ] **Step 5: Add the legacy EXTENSION guard and run GREEN**
...
- [ ] **Step 6: Commit the Admin extension lifecycle**
...
- [ ] **Step 1: Write failing calendar, idempotency, and channel-result tests**
...
- [ ] **Step 3: Implement calendar, enrollment, job claims, and worker dispatch**
...
- [ ] **Step 4: Implement renewal notification channels and exact environment keys**
...
- [ ] **Step 6: Commit renewal scheduling and reminders**
...
- [ ] **Step 1: Write failing Portal ownership and decision tests**
...
- [ ] **Step 3: Implement DTOs, service transactions, and routes**
...
- [ ] **Step 1: Write failing strict-template and snapshot tests**
...
- [ ] **Step 3: Implement generation, render model, and contract-version validation**
...
- [ ] **Step 1: Write failing Stage 3 mapping and race tests**
...
- [ ] **Step 3: Implement Stage 3 provider mapping and safe retries**
...
- [ ] **Step 4: Implement atomic finalization under row locks**
...
- [ ] **Step 1: Write failing segment-aware billing tests**
...
- [ ] **Step 3: Replace order-level end/price reads with segment resolver**
...
- [ ] **Step 4: Implement safe schedule continuation and GREEN tests**
...
- [ ] **Step 1: Write failing activation and continuity tests**
...
- [ ] **Step 3: Implement activation and entitlement adapters**
...
- [ ] **Step 1: Write failing expiry and return tests**
...
- [ ] **Step 3: Implement locked expiry transaction and task cancellation**
...
- [ ] **Step 4: Implement D+1 exception and allow normal return completion**
...
- [ ] **Step 1: Write failing view-model and page contract tests**
...
- [ ] **Step 3: Implement typed API/view model and Admin pages**
...
- [ ] **Step 1: Write failing Portal journey tests**
...
- [ ] **Step 3: Implement Portal types, API calls, pages, and continuous guidance**
...
- [ ] **Step 1: Write failing bootstrap, reconciliation, and end-to-end tests**
...
- [ ] **Step 3: Implement dry-run-first bootstrap and reconciliation**
...
- [ ] **Step 4: Add smoke flow and release runbook**
...
- [ ] **Step 6: Commit operational tooling and verification evidence**
...
- [ ] **Step 1: Build the acceptance traceability table**
