...
function buildReport({ applyBlocked, applyError, environment, mode, plans }) {
  ...
  return {
    ...
    applyError,
    auditNote:
      "legacyVehicleModelCodeSnapshot is an additive historical explanation field. Backfilled values are reconstructed from existing enum snapshots and do not alter original quote/order facts.",
    environment,
